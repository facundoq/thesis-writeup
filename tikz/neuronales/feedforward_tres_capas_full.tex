...
$o_1^0=x_1$ & |[plain]| \\
|[plain]| & $\theta_1(\wv_1^1 \cdot \ov^0)$  \\
$o_2^0=x_2$& |[plain]| & $\theta_2(\wv_1^2 \cdot \ov^1)$  \\
|[plain]| & |[plain]| \\
$o_3^0=x_3$ & $\theta_1(\wv_2^1 \cdot \ov^0)$\\
|[plain]| & |[plain]| \\
$o_4^0=x_4$ & |[plain]| &   $\theta_2(\wv_2^2 \cdot \ov^1)$ \\
|[plain]| & $\theta_1(\wv_3^1 \cdot \ov^0)$ \\
$o_5^0=x_5$ & |[plain]| \\
};
